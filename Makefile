...
pkgdatadir = $(datadir)/gst-rtsp-server
pkgincludedir = $(includedir)/gst-rtsp-server
pkglibdir = $(libdir)/gst-rtsp-server
pkglibexecdir = $(libexecdir)/gst-rtsp-server
...
am__DIST_COMMON = $(srcdir)/Makefile.in $(srcdir)/config.h.in \
	...
	$(top_srcdir)/common/win32.mak AUTHORS COPYING COPYING.LIB \
...
ACLOCAL = ${SHELL} /home/ubuntu/Downloads/Gstreamer1.9/gst-rtsp-server-1.11.90/missing aclocal-1.15
ACLOCAL_AMFLAGS = -I m4 -I common/m4
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AR = ar
AS = as
AUTOCONF = ${SHELL} /home/ubuntu/Downloads/Gstreamer1.9/gst-rtsp-server-1.11.90/missing autoconf
AUTOHEADER = ${SHELL} /home/ubuntu/Downloads/Gstreamer1.9/gst-rtsp-server-1.11.90/missing autoheader
AUTOMAKE = ${SHELL} /home/ubuntu/Downloads/Gstreamer1.9/gst-rtsp-server-1.11.90/missing automake-1.15
AWK = mawk
CAT_ENTRY_END = 
CAT_ENTRY_START = 
CC = gcc -std=gnu99
...
GSTPG_PLUGINS_DIR = 
GST_AGE = 1190
GST_ALL_CFLAGS = -I$(top_srcdir) -I$(top_builddir) -pthread -I/home/ubuntu/gstreamer/out/include/gstreamer-1.0 -I/usr/include/glib-2.0 -I/usr/lib/x86_64-linux-gnu/glib-2.0/include   -pthread -I/home/ubuntu/gstreamer/out/include/gstreamer-1.0 -I/usr/include/glib-2.0 -I/usr/lib/x86_64-linux-gnu/glib-2.0/include   $(GST_STATIC_CFLAGS) $(GST_OPTION_CFLAGS) $(GST_OPTION_CFLAGS)
GST_ALL_LDFLAGS = -no-undefined -Wl,-Bsymbolic-functions
GST_ALL_LIBS = -L/home/ubuntu/gstreamer/out/lib -lgstreamer-1.0 -lgobject-2.0 -lglib-2.0    $(GCOV_LIBS)
GST_API_VERSION = 1.0
...
GST_CFLAGS = -pthread -I/home/ubuntu/gstreamer/out/include/gstreamer-1.0 -I/usr/include/glib-2.0 -I/usr/lib/x86_64-linux-gnu/glib-2.0/include   $(GST_STATIC_CFLAGS) $(GST_OPTION_CFLAGS)
...
GST_OBJ_LIBS = $(top_builddir)/gst/rtsp-server/libgstrtspserver-1.0.la $(GST_ALL_LIBS)
...
LT_SYS_LIBRARY_PATH = 
MAINT = 
MAKEINFO = ${SHELL} /home/ubuntu/Downloads/Gstreamer1.9/gst-rtsp-server-1.11.90/missing makeinfo
MANIFEST_TOOL = :
MKDIR_P = /bin/mkdir -p
NM = /usr/bin/nm -B
NMEDIT = 
...
PACKAGE_STRING = GStreamer RTSP Server Library 1.11.90
...
XSLTPROC = 
XSLTPROC_FLAGS = 
abs_builddir = /home/ubuntu/Downloads/Gstreamer1.9/gst-rtsp-server-1.11.90
abs_srcdir = /home/ubuntu/Downloads/Gstreamer1.9/gst-rtsp-server-1.11.90
abs_top_builddir = /home/ubuntu/Downloads/Gstreamer1.9/gst-rtsp-server-1.11.90
abs_top_srcdir = /home/ubuntu/Downloads/Gstreamer1.9/gst-rtsp-server-1.11.90
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_DUMPBIN = 
am__include = include
...
docdir = $(datadir)/doc/gst-rtsp-server-1.0
dvidir = ${docdir}
exec_prefix = ${prefix}
...
install_sh = ${SHELL} /home/ubuntu/Downloads/Gstreamer1.9/gst-rtsp-server-1.11.90/install-sh
...
am--refresh: Makefile
	@:
$(srcdir)/Makefile.in:  $(srcdir)/Makefile.am $(top_srcdir)/common/win32.mak $(top_srcdir)/common/release.mak $(top_srcdir)/common/po.mak $(top_srcdir)/common/coverage/lcov.mak $(top_srcdir)/common/cruft.mak $(am__configure_deps)
	@for dep in $?; do \
...
check-exports:
	...
	for l in $(win32defs); do \
	  ...
	  libso=`find "$(top_builddir)" -name "$$libbase-1.0.so" | grep -v /_build/ | head -n1`; \
